...
contract UniswapV3Callback {
    ...
    function uniswapV3SwapCallback(
        ...
        assembly {
            ...
            case 0 {
                mstore(add(freeMemoryPointer, 36), amount0Delta) // Append the "amount" argument. Masking not required as it's a full 32 byte type.
            }
            default {
                mstore(add(freeMemoryPointer, 36), amount1Delta) // Append the "amount" argument. Masking not required as it's a full 32 byte type.
            }
